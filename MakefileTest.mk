...
test_job_receiver: tests/test_job_receiver.c src/job_receiver.c tests/test_utils.c src/preprocessing.c src/timed_queue.c src/linked_list.c src/common/timeutils.c src/simulation_stats.c src/logger.c include/job_receiver.h include/preprocessing.h include/linked_list.h include/timed_queue.h include/common/timeutils.h include/simulation_stats.h include/logger.h include/test_utils.h include/common/common.h
	$(CC) $(CFLAGS) -o $@ tests/test_job_receiver.c src/job_receiver.c tests/test_utils.c src/preprocessing.c src/timed_queue.c src/linked_list.c src/common/timeutils.c src/simulation_stats.c src/logger.c -lm -lpthread
